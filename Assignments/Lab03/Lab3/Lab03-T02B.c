...
uint8_t ui8PinData=6;       //creates an integer variable called ui8PinData
                            //and initializes it to 2.

int main(void)
{
    //2000000*3 CPU cycles = 6000000 CPU cycles
    //6000000/frequency = 0.333sec -> frequency = 6000000/0.333sec = 18.18MHz
    //400MHz PLL divided by 22
    ...
    while(1)
    {
        ...
        if(ui8PinData==6) {ui8PinData=10;}  //0110 (red+blue=purple)
        else if(ui8PinData==10)     //1010 (green+red=yellow)
        {ui8PinData=12;}
        else {ui8PinData=6;}    //1100 (blue+green=aqua)
    }
}
